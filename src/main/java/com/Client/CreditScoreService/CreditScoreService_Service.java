 ...
 * 
 */
@WebServiceClient(name = "CreditScoreService", targetNamespace = "http://service.web.credit.service.bank.org/", wsdlLocation = "http://datdb.cphbusiness.dk:8080/CreditBureau/CreditScoreService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CREDITSCORESERVICE_QNAME = new QName("http://service.web.credit.service.bank.org/", "CreditScoreService");
    ...
    public CreditScoreService getCreditScoreServicePort() {
        return super.getPort(new QName("http://service.web.credit.service.bank.org/", "CreditScoreServicePort"), CreditScoreService.class);
    }
    ...
    public CreditScoreService getCreditScoreServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.web.credit.service.bank.org/", "CreditScoreServicePort"), CreditScoreService.class, features);
    }
