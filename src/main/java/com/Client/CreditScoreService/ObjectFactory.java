 ...
 * generated in the com.Client.CreditScoreService package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreditScoreResponse_QNAME = new QName("http://service.web.credit.service.bank.org/", "creditScoreResponse");
    private final static QName _CreditScore_QNAME = new QName("http://service.web.credit.service.bank.org/", "creditScore");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.Client.CreditScoreService
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web.credit.service.bank.org/", name = "creditScoreResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web.credit.service.bank.org/", name = "creditScore")
